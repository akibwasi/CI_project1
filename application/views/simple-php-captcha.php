...
function simple_php_captcha($config = array()) {
    ...
    $bg_path = dirname(__FILE__) . '/application/views/backgrounds/';
    $font_path = dirname(__FILE__) . '/application/views/fonts/';
    ...
    if ( strpos($_SERVER['SCRIPT_FILENAME'], $_SERVER['DOCUMENT_ROOT']) ) {
        ...
        $image_src = 'application/views/' . ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
    } else {
