...
<body class="homepage">
   ...
   <div id="preloader"> 
	   <div id="status">
         <img src="<?php echo base_url(); ?>images/loader.gif" height="60" width="60" alt="">
            ...
            <div id="portfolio-wrapper" class="bgrid-fourth s-bgrid-third mob-bgrid-half group">
          	   ...
          	   <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                        <img src="<?php echo base_url(); ?>images/portfolio/grizzly.jpg" alt="Grizzly">
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                        <img src="<?php echo base_url(); ?>images/portfolio/hotel.jpg" alt="Hotel Sign">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>Hotel Sign</h5>
                              <p>Webdesign</p>
               ...
               <div class="bgrid stack item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                        <img src="<?php echo base_url(); ?>images/portfolio/beetle.jpg" alt="Beetle">                        
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>Beetle</h5>
                              <p>Branding</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                        <img src="<?php echo base_url(); ?>images/portfolio/banjo-player.jpg" alt="Banjo Player">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>Banjo Player</h5>
                              <p>Videography</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                     	<img src="<?php echo base_url(); ?>images/portfolio/coffee.jpg" alt="Coffee Cup">
                       	<div class="overlay">
                       		<div class="portfolio-item-meta">
          					      <h5>Coffee Cup</h5>
                              <p>Photography</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                        <img src="<?php echo base_url(); ?>images/portfolio/farmerboy.jpg" alt="Farmerboy">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>Farmerboy</h5>
                              <p>Branding</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">                        
                        <img src="<?php echo base_url(); ?>images/portfolio/judah.jpg" alt="Judah">                       
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>Judah</h5>
                              <p>Web Design</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="portfolio.html">
                        <img src="<?php echo base_url(); ?>images/portfolio/embossed-paper.jpg" alt="Embossed Paper">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
		         ...
		         <div id="team-wrapper" class="bgrid-half mob-bgrid-whole group">
		            ...
		            <div class="bgrid member">
		               ...
		               <div class="member-header">
		                 	...
		                 	<div class="member-pic">
									<img src="<?php echo base_url(); ?>images/team/member01-k.jpg" alt=""/>                        	                       	
		                 	</div>
		            ...
		            <div class="bgrid member">
		              	...
		              	<div class="member-header">
								...
								<div class="member-pic">
		                 		<img src="<?php echo base_url(); ?>images/team/member02-k.jpg" alt=""/>                        	
		                	</div>
		            ...
		            <div class="bgrid member first">
							...
							<div class="member-header">
								...
								<div class="member-pic">
		                		<img src="<?php echo base_url(); ?>images/team/member03-k.jpg" alt=""/>                        	
		               	</div>
		            ...
		            <div class="bgrid member">
		            	...
		            	<div class="member-header">
								...
								<div class="member-pic">
									<img src="<?php echo base_url(); ?>images/team/member04-k.jpg" alt=""/>                        	                        	
		                 	</div>
   ...
   <script>window.jQuery || document.write('<script src="<?php echo base_url(); ?>js/jquery-1.10.2.min.js"><\/script>')</script>
   ...
   <script src="<?php echo base_url(); ?>js/backstretch.js"></script> 
